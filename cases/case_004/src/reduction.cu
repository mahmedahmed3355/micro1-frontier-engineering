...
__global__ void block_reduce(
    ...
    for (int stride = 128; stride > 0; stride >>= 1) {
        ...
        /*
         * BUG:
         * Threads update shared memory while other threads may still
         * be reading or writing the same shared-memory region.
         *
         * No synchronization barrier establishes the required ordering
